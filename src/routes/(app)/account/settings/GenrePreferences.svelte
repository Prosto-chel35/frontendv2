...
<div
    class="h-96 overflow-y-auto rounded border bg-walnut-accent p-2 w-full text-black max-w-[400px] lg:w-[400px] " 
    ...
    {#each categories as category, parentIndex}
        <div class="mb-2">
            ...
            <button
                ...
                class="flex w-full items-center justify-between border rounded bg-walnut-accent p-2 text-left"
            >
            ...
            {#if category.expanded}
                <div class="mt-1 grid grid-cols-2 gap-2 bg-walnut-accent border p-2">
